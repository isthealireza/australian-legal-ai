...
class AuditEventType(StrEnum):
    ...
    EVIDENCE_DUPLICATE_REUSED = "EVIDENCE_DUPLICATE_REUSED"
    EVIDENCE_REVIEW_RECORDED = "EVIDENCE_REVIEW_RECORDED"
    EVIDENCE_DERIVATION_REGISTERED = "EVIDENCE_DERIVATION_REGISTERED"
    EVIDENCE_CHECKLIST_LINKED = "EVIDENCE_CHECKLIST_LINKED"
